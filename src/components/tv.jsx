...
<div className=' relative  border-b-[8px] border-b-slate-800   '> 
    ...
    <div className=' order-1 smm:w-1/2 smm:order-1'>
            <div className='flex flex-col smm:text-[32px] smm:pt-[52px]  justify-center  text-center  smm:text-left text-white mx-5  mt-10' >
                ...
                <p className='text-[32px]  smm:text-[48px] font-bold'> Enjoy on your TV </p>
                <p className='smm:text-[24px] text-[18px] mt-4  '> Watch on Smart TVs, Playstation, Xbox, Chromecast,  Apple TV, Blu-ray players, and more.</p>

            </div> 
    </div>


    <div className='order-1  ssm:w-1/2  smm:order-2 '>
    <div className='flex relative   justify-center items-center    mt-[10px] mb-[160px]'>
